...
curl -o config/iax.conf https://raw.githubusercontent.com/AdrienNini/ProjetAdmin/master/voip/config/iax.conf
curl -o config/queues.conf https://raw.githubusercontent.com/AdrienNini/ProjetAdmin/master/voip/config/queues.conf
